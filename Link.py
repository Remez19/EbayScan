...
class Link:
    ...
    def getLink(self):
        return self.link, str(self.totalSales), self.weekSales, self.currentDate, self.sellerName, self.sellerLink, self.feedBack, self.prodName, self.prodPrice, self.shippingCost, self.runTime, str(self.searchLink), None, None, None, None, None

    def setRunTime(self, runTime):
        self.runTime = runTime

    def setSearchLink(self, searchLink):
