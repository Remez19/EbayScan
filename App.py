...
class MainWindow(qtw.QMainWindow, Ui_MainWindow):
    ...
    def runNarkis(self):
        ...
        self.scanThread = ScanEbayThread(maxFeedBack, minFeedBack, maxSales, minSales, minWeekSales, minPrice, maxPrice,
...
class ScanEbayThread(qtc.QThread):
    ...
    def run(self):
        ebayScraper = EbayScraper(self.maxFeedBack, self.minFeedBack, self.maxSales, self.minSales, self.minWeekSales,
                                  self.minPrice,
                                  self.maxPrice,
